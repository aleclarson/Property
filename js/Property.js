...
var NamedFunction, Property, Proxy, isDev, mergeDefaults, needsProxy, validateConfig;
...
Property.prototype.define = function(target, key, config) {
  ...
  if (config.enumerable === void 0) {
    config.enumerable = (!isDev) || !(this.hidden || key.startsWith("_"));
  }
